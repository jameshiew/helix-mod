...
| `:write!`, `:w!` | Force write changes to disk, creating necessary subdirectories and overwriting in place if an atomic save is not possible. Accepts an optional path (:write! some/path.txt) |
